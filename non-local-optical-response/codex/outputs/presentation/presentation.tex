...
\begin{columns}[T,onlytextwidth]
  ...
  \centering
  \begin{tikzpicture}[x=1cm,y=1cm]
    \fill[softblue,rounded corners=6pt] (0,0) rectangle (7.2,4.45);
    \fill[orange!20] (3.75,0.35) rectangle (6.8,4.1);
    \draw[blue!75!black,very thick] (3.75,0.35)--(3.75,4.1);
    \node[font=\small] at (1.8,3.78){dielectric};
    \node[font=\small] at (5.35,3.78){metal};
    \foreach \y/\op in {0.9/0.18,1.25/0.35,1.6/0.60,1.95/0.9,2.3/1.0,2.65/0.82,3.0/0.48,3.35/0.22}{
      \fill[red,opacity=\op] (3.75+0.28*sin(150*\y),\y) circle (0.07);
      \fill[teal,opacity=\op] (3.75-0.32*sin(150*\y),\y) circle (0.07);
    }
    \draw[<->,red!75!black,thick] (3.25,0.65)--(4.25,0.65)
      node[midway,below,font=\scriptsize]{finite electronic width};
    \draw[teal!80!black,thick,->] (1.0,2.2)--(3.2,2.2)
      node[midway,above,font=\scriptsize]{confined optical field};
    \node[draw=blue,fill=white,rounded corners,align=center,font=\scriptsize,text width=2.0cm] at (5.35,2.15)
      {charge and current respond across space};
  \end{tikzpicture}
...
\begin{columns}[T,onlytextwidth]
  ...
  \begin{itemize}
    ...
    \item The induced charge is assigned to a mathematically sharp interface.
    \item Refining the mesh improves the solution, not the constitutive law.
  \end{itemize}
  \column{0.46\textwidth}
  \centering
  \begin{tikzpicture}[x=1cm,y=0.97cm]
    \fill[softblue] (0,0) rectangle (5.3,3.55);
    \fill[orange!20] (2.8,0) rectangle (5.3,3.55);
    \draw[blue!75!black,very thick] (2.8,0)--(2.8,3.55);
    \foreach \y in {0.55,0.95,...,3.0}{\fill[red] (2.8,\y) circle (0.055);}
    \draw[teal!80!black,very thick,->] (0.45,1.8)--(2.35,1.8);
    \draw[teal!80!black,very thick,->] (3.25,1.8)--(4.9,1.8);
    \node[font=\scriptsize] at (1.4,3.15){dielectric};
    \node[font=\scriptsize] at (4.05,3.15){metal};
    \node[font=\scriptsize,align=center,text width=4.6cm] at (2.65,0.28)
      {all induced charge sits at one reference plane};
  \end{tikzpicture}
...
\begin{columns}[T,onlytextwidth]
  ...
  \centering
  \begin{tikzpicture}[x=0.88cm,y=0.9cm]
    \draw[->,thick] (0,0)--(5.15,0) node[right,font=\scriptsize]{$L_{\rm field}$};
    \draw[->,thick] (0,0)--(0,3.2) node[above,font=\scriptsize]{confidence in LRA};
    \draw[blue!75!black,very thick] plot[smooth] coordinates{(0.25,2.9)(1.2,2.78)(2.1,2.45)(3.0,1.8)(3.85,1.0)(4.9,0.28)};
    \draw[dashed,red!75!black] (2.55,0)--(2.55,3.0);
    \node[font=\scriptsize,blue!75!black] at (1.0,2.42){bulk local response};
    \node[font=\scriptsize,align=center,text width=2.4cm,red!75!black] at (4.05,2.15)
      {surface, nonlocal, or transport response};
    \node[font=\scriptsize] at (2.55,0.38){$L_{\rm field}\sim\ell$};
  \end{tikzpicture}
  \shortcite{J. A. Scholl et al., Nature 483, 421 (2012); W. Zhu et al., Nat. Commun. 7, 11495 (2016).}
\end{columns}
\end{frame}
...
\begin{columns}[T,onlytextwidth]
  ...
  \begin{block}{Three gap regimes}
    \begin{enumerate}
      ...
      \item \textbf{Nonlocal:} screening charge shifts by a finite centroid, changing the optical gap.
      \item \textbf{Tunnelling:} current crosses the gap and charge-transfer modes appear.
    \end{enumerate}
  \end{block}
...
\begin{columns}[T,onlytextwidth]
  ...
  \begin{block}{Perpendicular charge centroid}
    ...
    \]
    $d_\parallel(\omega)$ similarly encodes the centroid of the tangential-current response.
  \end{block}
  \begin{itemize}
  ...
  \centering
  \begin{tikzpicture}[x=1cm,y=1cm]
    \fill[softblue] (0,0) rectangle (5.5,3.5);
    \fill[orange!18] (2.75,0) rectangle (5.5,3.5);
    \draw[blue!70!black,very thick] (2.75,0)--(2.75,3.5);
    \draw[red!80!black,very thick] plot[smooth] coordinates{
      (1.0,0.35)(1.6,0.42)(2.15,0.68)(2.55,1.35)(2.85,2.7)(3.15,2.0)(3.65,0.75)(4.4,0.4)};
    \draw[dashed,teal!80!black,thick] (3.03,0.2)--(3.03,3.2);
    \draw[<->,teal!80!black,thick] (2.75,3.05)--(3.03,3.05)
      node[midway,above,font=\scriptsize]{$d_\perp$};
    \node[font=\scriptsize] at (2.75,0.22){reference plane};
    \node[font=\scriptsize,red!75!black] at (4.0,2.65){$\rho_{\rm ind}(z)$};
  \end{tikzpicture}
  ...
  \end{alertblock}
\end{columns}
\shortcite{P. J. Feibelman, Prog. Surf. Sci. 12, 287 (1982); N. A. Mortensen et al., Nanophotonics 10, 3647 (2021).}
\end{frame}
...
\begin{columns}[T,onlytextwidth]
  ...
  \centering
  \begin{tikzpicture}[x=1cm,y=1cm]
    \fill[softblue] (0,0) rectangle (6.1,3.25);
    \draw[very thick,blue!65!black] (3.05,0)--(3.05,3.25);
    \draw[orange!85!black,very thick] plot[smooth] coordinates{
      (0.35,2.55)(1.2,2.55)(2.0,2.5)(2.5,2.25)(2.85,1.65)(3.15,1.05)(3.6,0.65)(4.3,0.48)(5.75,0.45)};
    \draw[teal!80!black,very thick] plot[smooth] coordinates{
      (0.35,0.72)(1.2,0.72)(2.0,0.78)(2.55,1.03)(3.05,1.55)(3.55,2.05)(4.2,2.38)(5.75,2.52)};
    \node[font=\scriptsize] at (1.0,2.82){$n_0(z)$};
    \node[font=\scriptsize] at (5.0,2.82){local material profile};
    \draw[<->,red!75!black,thick] (2.38,2.9)--(3.62,2.9)
      node[midway,above,font=\scriptsize]{spill-out / spill-in};
    \node[font=\scriptsize] at (3.05,0.22){ionic boundary};
  \end{tikzpicture}
  ...
  \end{itemize}
\end{columns}
\shortcite{N. A. Mortensen et al., Nanophotonics 10, 3647 (2021).}
\end{frame}
...
\begin{tikzpicture}[node distance=0.25cm,every node/.style={font=\scriptsize,align=center,text width=2.25cm,inner sep=2pt}]
  ...
  \node[draw=blue,fill=softblue,rounded corners,minimum width=2.45cm,minimum height=1.0cm,right=of b] (c)
    {modified boundary conditions\\BEM / FEM / scattering};
...
\begin{columns}[T,onlytextwidth]
  ...
  \begin{block}{Capacitive junction}
    \centering
    \begin{tikzpicture}[x=1cm,y=1cm]
      \fill[orange!45] (0,0) rectangle (0.8,1.25);
      \fill[orange!45] (2.2,0) rectangle (3.0,1.25);
      \draw[<->,thick] (0.8,0.63)--(2.2,0.63) node[midway,above,font=\scriptsize]{$g$};
      \draw[teal,thick,->] (1.05,0.25)--(1.95,0.25);
    \end{tikzpicture}
    \smallskip
    Bonding dimer plasmon redshifts as the dielectric gap shrinks.
  \end{block}
  \column{0.31\textwidth}
  \begin{block}{Conductive crossover}
    \centering
    \begin{tikzpicture}[x=1cm,y=1cm]
      \fill[orange!45] (0,0) rectangle (0.8,1.25);
      \fill[orange!45] (2.2,0) rectangle (3.0,1.25);
      \draw[red,very thick,->] (0.8,0.63)--(2.2,0.63);
      \node[font=\scriptsize] at (1.5,0.94){$J_\omega$};
    \end{tikzpicture}
    \smallskip
    Optical crossover follows junction conductance, not only nominal gap size.
  \end{block}
  \column{0.31\textwidth}
  \begin{block}{Charge-transfer mode}
    \centering
    \begin{tikzpicture}[x=1cm,y=1cm]
      \fill[orange!45] (0,0) rectangle (1.2,1.25);
      \fill[orange!45] (1.8,0) rectangle (3.0,1.25);
      \draw[red,very thick,->] (1.2,0.72)--(1.8,0.72);
      \draw[teal,very thick,->] (1.8,0.28)--(1.2,0.28);
    \end{tikzpicture}
    \smallskip
    The gap is no longer a purely dielectric interface; transport must enter.
  \end{block}
\end{columns}
\begin{alertblock}{Why this matters for model choice}
  $d$ parameters and hard-wall hydrodynamics describe separated bodies. A conducting junction needs QCM, NEGF, or another transport-calibrated response.
\end{alertblock}
\shortcite{K. J. Savage et al., Nature 491, 574 (2012); S. F. Tan et al., Science 343, 1496 (2014).}
\end{frame}
...
\begin{columns}[T,onlytextwidth]
  ...
  \begin{alertblock}{Volume-response route}
    ...
    \]
    Needed when longitudinal density motion and finite compressibility inside the metal matter.
  \end{alertblock}
  \begin{itemize}
...
\end{columns}
\vspace{0.3em}
\key{The two routes are complementary compressions of the same microscopic response.}
\end{frame}
...
\begin{columns}[T,onlytextwidth]
  ...
  \centering
  \begin{tikzpicture}[x=1cm,y=1cm]
    \fill[orange!18,rounded corners] (0,0) rectangle (5.2,3.5);
    \foreach \x in {0.5,1.0,...,4.7}{
      \draw[blue!70!black,thick,->] (\x,0.45)--(\x+0.25,0.45);
    }
    \draw[red!75!black,very thick] plot[smooth] coordinates{
      (0.25,1.65)(0.8,2.5)(1.35,1.65)(1.9,0.8)(2.45,1.65)(3.0,2.5)(3.55,1.65)(4.1,0.8)(4.65,1.65)};
    \node[font=\scriptsize] at (2.6,3.05){longitudinal density oscillation};
    \node[font=\scriptsize] at (2.6,0.18){current and charge are solved as fields};
  \end{tikzpicture}
  \begin{alertblock}{Why it is attractive}
    It adds nonlocal dynamics while remaining compatible with continuum electromagnetism and device-scale geometries.
  \end{alertblock}
\end{columns}
\shortcite{N. A. Mortensen et al., Nat. Commun. 5, 3809 (2014).}
\end{frame}
...
\begin{columns}[T,onlytextwidth]
  ...
  \centering
  \begin{tikzpicture}[x=1cm,y=1cm]
    \draw[blue!60!black,thick] (2.55,0.25)--(2.55,3.45);
    \fill[orange!15] (2.55,0.25) rectangle (5.2,3.45);
    \draw[orange!85!black,very thick] plot[smooth] coordinates{
      (0.2,0.55)(1.0,0.55)(1.7,0.62)(2.15,0.95)(2.55,1.75)(2.95,2.55)(3.5,2.88)(4.3,2.95)(5.0,2.95)};
    \draw[teal!80!black,very thick] plot[smooth] coordinates{
      (0.25,2.85)(1.0,2.75)(1.7,2.4)(2.2,1.85)(2.55,1.3)(2.95,0.9)(3.6,0.65)(5.0,0.58)};
    \node[font=\scriptsize,orange!85!black] at (4.25,3.22){$n_0$};
    \node[font=\scriptsize,teal!80!black] at (0.95,3.1){induced mode};
    \node[font=\scriptsize] at (2.55,0.1){ionic radius};
  \end{tikzpicture}
  ...
  \end{alertblock}
\end{columns}
\shortcite{N. A. Mortensen et al., Nanophotonics 10, 3647 (2021); C. Mystilidis et al., Nanophotonics 15, e70179 (2026).}
\end{frame}
