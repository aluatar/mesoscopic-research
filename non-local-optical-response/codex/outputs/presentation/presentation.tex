...
\begin{columns}[T,onlytextwidth]
  ...
  \begin{itemize}
    ...
    \item In the VIE/OpenSANS benchmark, the LRA dipole is radius-flat; nonlocal HDM retains a size trend.
  ...
  \includegraphics[
    ...
    keepaspectratio
  ]{assets/photo_2026-07-27_11-23-01.jpg}
  \shortcite{G. Toscano et al., Nat. Commun. 6, 7132 (2015), Fig. 4; C. Mystilidis et al., Nanophotonics 15, e70179 (2026), Fig. 2.}
\end{columns}
\end{frame}
...
\begin{columns}[T,onlytextwidth]
  ...
  \begin{itemize}
    ...
    \item $d_\perp$ captures the induced-charge displacement created by spill-out or spill-in.
  ...
  \begin{alertblock}{What the moments capture}
    Spill-out moves the induced charge away from the ionic reference plane.  $d_\perp$ retains this displacement as one complex surface moment.
  \end{alertblock}
\end{columns}
\end{frame}
